...
//			new Rect (Screen.width - 80 - w + 5, Screen.height * 0.1f - 40 + 3,(h-10)/2,(h-10)/2);
		...
		nbBooks.guiText.anchor = TextAnchor.MiddleCenter;
...
//			new Rect (Screen.width - 80 - w_ + 5, Screen.height * 0.1f - 40 + 3,(h_-10)/2,(h_-10)/2);
		...
		bookIcon.guiTexture.pixelInset = 
			new Rect (Screen.width - 80 - w_ + 5, Screen.height * 0.1f - 40 + 7 , (h_-10),(h_-10));

		nbBooks.guiText.pixelOffset =
			new Vector2 (Screen.width - 80 - w_ + (h_-10) + (w_ - (h_-10)/2)/3, Screen.height * 0.1f - 40 + 7 + h_/2.5f);
...
public class HeadUpDisplay : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetKeyDown (KeyCode.I) || Input.GetButtonDown("MapSwitch")) {
